...
f_out = File.new("jingdong_base","a")
log = File.new("log_jingdong","a")
max_id = ""
...
while true
  begin
     ...
     if max_id ==""
       res = client.user_timeline({:id=>JINGDONG,:count=>200})
     else
       res = client.user_timeline({:id=>JINGDONG,:max_id=>max_id,:count=>200})
       res.shift
     end
