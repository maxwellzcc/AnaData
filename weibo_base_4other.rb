...
f_out = File.new("tmall_base","a")
log = File.new("log_tmall","a")
#这是第2009条的id
max_id = "3360363401692130"
...
while true
  begin
     ...
     if max_id ==""
       res = client.user_timeline({:id=>TMALL,:count=>200})
     else
       res = client.user_timeline({:id=>TMALL,:max_id=>max_id,:count=>200})
       res.shift
     end
